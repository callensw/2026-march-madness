...
def build_agents(multi_model: bool = False) -> list[AgentConfig]:
    ...
    confidence_calibration = (
        "\nEFFICIENCY REALITY CHECK — READ THIS FIRST:\n"
        "Season-long efficiency margins predict game outcomes roughly 60-65% of the time, NOT 90%. "
    ...
    agents = [
        ...
        AgentConfig(
            ...
            system_prompt=(
                ...
                "CONVICTION RULE: If the lower seed's 3PT% is within 2 points of the higher seed OR above 36%, "
                "your probability for the higher seed CANNOT exceed 0.55. You BELIEVE in shooting variance — act like it.\n\n"
                "YOUR ANALYSIS MUST BE:\n"
                "- Maximum 40 words for your argument\n"
                "- One key stat cited (the specific number, not a paragraph about it)\n"
                "- Your probability + uncertainty\n"
        ...
        AgentConfig(
            ...
            system_prompt=(
                ...
                "CONVICTION RULE: If the lower seed has experience_score above 7.0 AND is a conference "
                "tournament champion, your probability for the higher seed CANNOT exceed 0.55. Veterans "
                "who just won their conference are the most dangerous teams in March.\n\n"
                "YOUR ANALYSIS MUST BE:\n"
                "- Maximum 40 words for your argument\n"
                "- One key stat cited (the specific number, not a paragraph about it)\n"
                "- Your probability + uncertainty\n"
        ...
        AgentConfig(
            ...
            system_prompt=(
                ...
                "CONVICTION RULE: If the higher seed has a significant travel disadvantage (1000+ more miles "
                "than the lower seed) OR fewer rest days, lower your probability for the higher seed by at "
                "least 5 points from where you'd otherwise set it. Fatigue is REAL and it compounds.\n\n"
                "YOUR ANALYSIS MUST BE:\n"
                "- Maximum 40 words for your argument\n"
                "- One key stat cited (the specific number, not a paragraph about it)\n"
                "- Your probability + uncertainty\n"
        ...
        AgentConfig(
            ...
            system_prompt=(
                ...
                "- Cite historical base rates or specific years (that's Oracle's lane)\n"
                "- Talk about injuries or rest (that's Whisper's lane)\n\n"
                "CONVICTION RULE: If the lower seed has a LONGER winning streak than the higher seed "
                "AND the higher seed lost their last game or has 3+ losses in their last 5, you MUST "
                "pick the lower seed. Momentum doesn't lie. A fading favorite vs a peaking underdog = upset.\n\n"
                "YOUR ANALYSIS MUST BE:\n"
                "- Maximum 40 words for your argument\n"
                "- One key stat cited (the specific number, not a paragraph about it)\n"
                "- Your probability + uncertainty\n"
